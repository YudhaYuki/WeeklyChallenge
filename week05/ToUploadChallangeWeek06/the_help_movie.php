    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item active">
          <a class="nav-link navbar-font-color" href="#">The help movie <span class="index.html"><!-- current page --> </span></a>
        </li>
        <li class="nav-item">
          <a class="nav-link navbar-font-color" href="#">Cast</a>
        </li>
        <li class="nav-item">
          <a class="nav-link navbar-font-color" href="#">Award</a>
        </li>
        <li class="nav-item">
          <a class="nav-link navbar-font-color" href="#">Comment</a>
        </li>
      </ul>
